...
**Status:** Phases 1-7(1+2) + phase 8 (slices 1-5) + phase 6.3b + 6.3c(parts 1+2a) shipped 2026-05-03. Phase 7.3 BLOCKED behind 6.3c part 2b (buffer-rescued governance attribution) + locations_stage retire (audit at [docs/harmony-7-3-audit.md](harmony-7-3-audit.md)). Phase 8 = curator-on-canonical-tables migration (see `~/.claude/projects/C--Users-beach/memory/project_curator_on_canonical_tables.md`). New curator surface is `admin/beach-editor-gold.html`; legacy `location-editor.html` carries a deprecation banner pointing at it.
