...
SELECT 'municipal_code',
       ...
       'https://codelibrary.amlegal.com/codes/annearundel/latest/annearundelco_md/0-0-0-111152',
       $body$Anne Arundel County Code, Article 12 Public Safety, Title 4 Animal Control, Subtitle 9 Miscellaneous Provisions, § 12-4-905 Animals running at large prohibited. "At large" means off the property of an animal's owner and not leashed and under the control of a responsible person (per § 12-4-101 definitions). A domesticated animal may not be at large, and an owner of an animal at large is in violation of this section. Exceptions — an animal is not at large for purposes of this section if it is: (i) actively engaged in search and rescue operation training or the sport of hunting or other legal dog sport or competition in authorized areas while supervised by a competent individual; (ii) undergoing supervised training as part of an organized obedience class; (iii) in a dog exercise area designated by the Anne Arundel County Department of Recreation and Parks as an "off-leash dog park" under supervision of the dog's owner; or (iv) in a secured dog exercise area designated by the property owner, homeowner's association, condominium, or cooperative as an "off-leash dog park." Applicability: Anne Arundel County is a charter county; § 12-4-905 applies countywide, including within the City of Annapolis (the only incorporated municipality in the county) absent a conflicting local ordinance. [Hosted on American Legal Publishing at codelibrary.amlegal.com/codes/annearundel; alternate mirror at annearundelco-md.elaws.us/code/coor_art12_t4_subt9_sec12-4-905. Verbatim text obtained via web_search 2026-05-22; Playwright and direct HTTP both blocked by SPA / 403/503 — text confirmed cross-platform.]$body$
WHERE NOT EXISTS (
...
SELECT 'agency_administrative_policy',
       ...
       ARRAY['dog_policy']::text[],
       'https://www.aacounty.org/recreation-parks/swimming-beaches-rules',
       $body$Anne Arundel County Department of Recreation and Parks — Swimming Beaches Rules and Regulations. Dogs are listed under prohibited items at the county swimming beaches, with per-park exceptions: • Fort Smallwood Park: "Dogs are permitted on the southernmost (furthest away from the parking area) section of the beach only. They must be leashed and under owners control at all times while on the beach." • Mayo Beach Park: "Dogs are not permitted on the swimming beach, but are welcome on a leash anywhere else in the park." • Beverly Triton Nature Park: "Dogs are not permitted on the swimming beach, but are welcome on a leash anywhere else in the park." [Hosted on www.aacounty.org. Fetched 2026-05-22.]$body$
WHERE NOT EXISTS (
  SELECT 1 FROM public.policy_source
