-- Bulk writer: persist the v3 advisory breakdown into
-- beach_day_hourly_scores.explainability under a namespaced 'advisory_v3'
-- key {penalty_total, components[]}. Additive jsonb_set merge — the v2
-- metric scores scoreHours writes earlier are preserved. Mirrors the
-- singleton compute_beach_hourly_v2 advisory_components (20260618d).
-- Dog-park sibling: 20260618g.
